...
function countRectangleArea(length, width) {
	return length * width + " sm";
}

console.log(countRectangleArea (rectangle.length, rectangle.width));
...
console.log("The wole distance is " + (speedOfFirst + speedOfSecond) * time + " kilometers");
